...
permalink: /:title/
categories: [cybersec, write-up, shellcode, flare7]
...
![]({{site.url}}{{page.images_prefix}}attack_context.png)
...
![]({{site.url}}{{page.images_prefix}}attack.png)
...
![]({{site.url}}{{page.images_prefix}}first_exploit.png)
...
![]({{site.url}}{{page.images_prefix}}metasploit_module.png)
...
![]({{site.url}}{{page.images_prefix}}attack_streams.png)
...
![]({{site.url}}{{page.images_prefix}}encoder_metasploit.png)
...
![]({{site.url}}{{page.images_prefix}}shellcode_fixed.png)

Rather then:

![]({{site.url}}{{page.images_prefix}}unfixed_shellcode.png)
...
![]({{site.url}}{{page.images_prefix}}shellcode_running.png)
...
![]({{site.url}}{{page.images_prefix}}scdbg_half_complet.png)
...
![]({{site.url}}{{page.images_prefix}}x64dbg_session.png)
...
![]({{site.url}}{{page.images_prefix}}loading_winsock.png)
...
![]({{site.url}}{{page.images_prefix}}EBP_BREAKS.png)
...
![]({{site.url}}{{page.images_prefix}}intrepidmango.png)
...
![]({{site.url}}{{page.images_prefix}}encode_routine.png)
...
![]({{site.url}}{{page.images_prefix}}fakec2_final.png)
...
![]({{site.url}}{{page.images_prefix}}never_give_up.png)
